...
NMilitary = {
	...
	FIELD_EXPERIENCE_MAX_PER_DAY = 3,				-- Most army xp you can gain per day
	...
	UNIT_DIGIN_CAP = 5,                           -- how "deep" you can dig in until hitting max bonus
	...
	PLAN_PROVINCE_HIGH_VP_IMPORTANCE_AREA = 50.0,   -- Used when calculating the value of defense area in the battle plan system

	PLAN_PROVINCE_LOW_VP_IMPORTANCE_FRONT = 2.0,    -- Used when calculating the value of fronts in the battle plan system
	PLAN_PROVINCE_MEDIUM_VP_IMPORTANCE_FRONT = 3.0, -- Used when calculating the value of fronts in the battle plan system
	PLAN_PROVINCE_HIGH_VP_IMPORTANCE_FRONT = 4.0,  -- Used when calculating the value of fronts in the battle plan system
...
NAir = {
	...
	COMBAT_MAX_WINGS_AT_GROUND_ATTACK = 15,	        	-- we can really pounce a land strike and escalate
	COMBAT_MAX_WINGS_AT_ONCE_PORT_STRIKE = 6,        -- we can really pounce a naval strike and escalate
	COMBAT_ATTACK_PASSES_AT_ONCE = 0.05,					-- Wing attack stat determines of many re-approaches in single combat they do. This is a scale of this amount to balance the gameplay. Less retries = less bloody combats, and less calculations for the CPU.
	...
	STRATEGIC_BOMBER_NUKE_AIR_SUPERIORITY = 0.75,		-- How much air superiority is needed for a strategic bomber to be able to nuke a province
...
NNavy = {
	...
	ANTI_AIR_TARGETTING_TO_CHANCE = 0.10,							-- Balancing value to convert averaged equipment stats (anti_air_targetting and naval_strike_agility) to probability chances of airplane being hit by navies AA.
	ANTI_AIR_ATTACK_TO_AMOUNT = 0.010,								-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit.
	...
	EXPERIENCE_FACTOR_NON_CARRIER_GAIN = 0.07,						-- Xp gain by non-carrier ships in the combat
	EXPERIENCE_FACTOR_CARRIER_GAIN = 0.07,							-- Xp gain by carrier ships in the combat
...
NAI = {
	...
	DIVISION_UPGRADE_MIN_XP = 50,				-- Minimum XP before attempting to upgrade a division template.
	DIVISION_CREATE_MIN_XP = 150,				-- Minimum XP before attempting to create a fresh new division template.
	VARIANT_UPGRADE_MIN_XP = 200,				-- Minimum XP before attempting to create a new variant.
	...
	HOUR_BAD_COMBAT_REEVALUATE = 72,                   -- if we are in combat for this amount and it goes shitty then try skipping it
